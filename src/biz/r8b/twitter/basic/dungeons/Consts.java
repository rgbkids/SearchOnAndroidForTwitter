...
public class Consts {
    ...
    public static final String ACTION_CONFIRM_NOTIFICATION =
        "biz.r8b.twitter.basic.dungeons.CONFIRM_NOTIFICATION";
    public static final String ACTION_GET_PURCHASE_INFORMATION =
        "biz.r8b.twitter.basic.dungeons.GET_PURCHASE_INFORMATION";
    public static final String ACTION_RESTORE_TRANSACTIONS =
        "biz.r8b.twitter.basic.dungeons.RESTORE_TRANSACTIONS";
