...
package biz.r8b.twitter.basic.dungeons;

import biz.r8b.twitter.basic.BaseActivity;
import biz.r8b.twitter.basic.R;
import biz.r8b.twitter.basic._App;
import biz.r8b.twitter.basic.dungeons.BillingService.RequestPurchase;
import biz.r8b.twitter.basic.dungeons.BillingService.RestoreTransactions;
import biz.r8b.twitter.basic.dungeons.Consts.PurchaseState;
import biz.r8b.twitter.basic.dungeons.Consts.ResponseCode;
    ...
    private class DungeonsPurchaseObserver extends PurchaseObserver {
        ...
        public void onRequestPurchaseResponse(RequestPurchase request,
            ...
            if (responseCode == ResponseCode.RESULT_OK) {
                ...
                // add
                BaseActivity.putString(Dungeons.this, "product", "true");
                ...
                // add
                BaseActivity.putString(Dungeons.this, "product", "");
            } else {
                if (Consts.DEBUG) {
...
//    	new CatalogEntry("negi_001", R.string.negi_001, Managed.MANAGED),
    	new CatalogEntry(_App.KAKIN_ID, _App.KAKIN_RID, Managed.MANAGED),
    };
    ...
    static Activity activity; // add

    /** Called when the activity is first created. */
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.main_dungeons);
    ...
    private void logProductActivity(String product, String activity) {
        ...
        // add
        if (product != null
        		&& product.equals(_App.KAKIN_ID) && activity.trim().equals("PURCHASED"))
        {
        	// kounyuu zumi
        	BaseActivity.putString(Dungeons.this, "product", "true");
        	BaseActivity.toast(Dungeons.this, _App.KAKIN_ID + "... " + "OK!");
        }
    }
    ...
    private static class CatalogAdapter extends ArrayAdapter<String> {
        ...
        public void setOwnedItems(Set<String> ownedItems) {
            ...
            BaseActivity.setOwnedItems(activity, ownedItems); // add
        }
