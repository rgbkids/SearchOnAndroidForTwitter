...
// QueryTab2Activityと同系統
public class TwUserTimelineActivity extends BaseActivity implements IfLoad {
	public static String ScreenName; // 引数
	public static int PageNo; // 引数

	//
	/*static*/ String screenName; // 引数
	public /*static*/ int pageNo; // 引数
...
//        }
        ...
        filter1.setText((ja)?"URL�𒊏o":"urls");
...
//    			TwQueryResultActivity.setSavedSearch(savedSearch);
        ...
        filter2.setText((ja)?"�ʐ^�𒊏o":"photos");
